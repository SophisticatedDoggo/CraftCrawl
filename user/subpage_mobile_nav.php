...
?>
<div class="mobile-actions-menu user-subpage-actions-menu" data-mobile-actions-menu>
...
<nav class="mobile-app-tabbar user-subpage-tabbar" aria-label="Account navigation">
