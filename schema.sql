...
CREATE TABLE IF NOT EXISTS levels (
    ...
    UNIQUE KEY unique_levels_xp_required (xp_required)
);
...
CREATE TABLE IF NOT EXISTS locations (
    ...
    social_facebook VARCHAR(2048),
    social_instagram VARCHAR(2048),
    social_tiktok VARCHAR(2048),
    social_x VARCHAR(2048),
...
CREATE TABLE IF NOT EXISTS feed_notification_reads (
    ...
    user_id INT NOT NULL,
    feed_item_key VARCHAR(100) NOT NULL,
    notification_type ENUM('feed_item', 'comment', 'reaction') NOT NULL,
...
CREATE TABLE IF NOT EXISTS location_import_batches (
    ...
    KEY idx_location_import_batches_operation (operation_id),
