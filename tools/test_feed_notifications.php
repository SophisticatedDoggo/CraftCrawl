...
feed_notification_assert(strpos($style_source, ".friends-feed-item.notification-focus-target {\n    animation: none;") !== false, 'cleared feed cards must not fall back to the generic focus animation');
