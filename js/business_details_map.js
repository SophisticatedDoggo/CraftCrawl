window.CraftCrawlInitBusinessDetailsMap = function (root = document) {
    const businessLocationMapContainer = root.querySelector('#business-location-map');

    if (!businessLocationMapContainer || businessLocationMapContainer.dataset.businessDetailsMapReady === 'true' || !window.mapboxgl || !window.MAPBOX_ACCESS_TOKEN) {
        return false;
    }
    ...
    businessLocationMapContainer.dataset.businessDetailsMapReady = 'true';
...
window.CraftCrawlInitBusinessDetailsMap();
